...
\noindent \textbf{Note: Class will not meet on April 1.}
...
\clearpage
\subsection{External Validity (Apr 8)}
...
\noindent\textbf{Note: Students should present a synopsis today.}
\vspace{1em}
...
\clearpage
\subsection{Effect Sizes, Meta-Analysis, Decision Making (Apr 15)}
